...
e_array = tc_project.pv_arrays.create!(caption: "East",
                              description: "Eastern Array", 
                              label: "E",
                              latitude: tc_project.latitude,
                              longitude: tc_project.longitude,
                              tilt: 12,
                              azimuth: 99)
                              
w_array = tc_project.pv_arrays.create!(caption: "West",
                              description: "Western Array", 
                              label: "W",
                              latitude: tc_project.latitude,
                              longitude: tc_project.longitude,
                              tilt: 12,
...
File.open('./script/TC_pv.csv', 'r') do |f1|
  f1.gets
  while line = f1.gets
    tmp = line.split(',')
    uuid = tmp[12].to_i
